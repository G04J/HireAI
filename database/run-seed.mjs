 ...
 *
 * Usage:  node database/run-seed.mjs
 */
...
console.log('🔐  Creating auth accounts for 31 candidates…');
const CANDIDATES = [
  ...
  { email: 'anna.mark@email.com',        name: 'Anna Mark',         summary: 'Junior software engineer with a few years of experience; steady growth in web and backend development.', phone: '+1-555-0131' },
];
...
// ── Step 5b: Populate Anna Mark's candidate_profile ────────────────────────
const anna = CANDIDATES.find((x) => x.email === 'anna.mark@email.com');
if (anna?.uid) {
  console.log('📝  Populating Anna Mark candidate profile…');
  const annaProfile = {
    user_id: anna.uid,
    location: 'Austin, TX',
    linkedin_url: 'https://linkedin.com/in/annamark',
    github_url: 'https://github.com/annamark',
    career_objective: 'Seeking a role where I can grow as a software engineer and contribute to meaningful products. Interested in full-stack and backend development.',
    ...
    languages: ['English'],
    education: [
      { institution: 'University of Texas at Austin', degree: 'B.S.', field_of_study: 'Computer Science', start_date: '2017-09', end_date: '2021-05', gpa: '3.4', description: 'Relevant coursework: Data structures, algorithms, web development, databases.' },
    ],
    work_experience: [
      { company: 'TechStart Solutions', title: 'Junior Software Engineer', location: 'Austin, TX', start_date: '2021-06', end_date: '2024-01', description: 'Built and maintained internal tools and customer-facing features. Worked in an Agile team on a React/Node.js stack.', achievements: ['Shipped 3 production features', 'Reduced API latency by 15%', 'Mentored one intern'] },
      { company: 'Local Dev Shop', title: 'Software Development Intern', location: 'Austin, TX', start_date: '2020-06', end_date: '2020-08', description: 'Full-stack development and bug fixes for client projects.', achievements: ['Delivered 2 client projects on time'] },
    ],
    projects: [
      { title: 'Task Dashboard', description: 'Personal productivity app with React and Express. Auth, CRUD, and simple analytics.', technologies: ['React', 'Node.js', 'PostgreSQL'], url: 'https://github.com/annamark/task-dashboard', start_date: '2023-01', end_date: '2023-03' },
      { title: 'API Rate Limiter', description: 'Small library for in-memory rate limiting used in side projects.', technologies: ['TypeScript', 'Node.js'], url: 'https://github.com/annamark/rate-limiter', start_date: '2022-06', end_date: '2022-08' },
    ],
    certifications: [
      { name: 'AWS Certified Cloud Practitioner', issuing_organization: 'Amazon Web Services', date_obtained: '2023-04', expiry_date: '', credential_id: '' },
    ],
    achievements: [
      { title: 'Spot bonus for delivery', description: 'Recognition for on-time delivery of a critical feature.', date: '2023-09' },
    ],
    completeness_score: 85,
  };
  await supabase.from('candidate_profiles').upsert(annaProfile, { onConflict: 'user_id' });
  console.log('   Done.\n');
}
