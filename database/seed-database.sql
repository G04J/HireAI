-- Seed data: ~31 candidates, 7 employers, 40 jobs (run after supabase-schema.sql in Supabase SQL Editor)
...
INSERT INTO public.users (id, email, full_name, profile_summary, phone) VALUES
  ...
  ('c1000031-0000-4000-8000-000000000031', 'anna.mark@email.com', 'Anna Mark', 'Junior software engineer with a few years of experience; steady growth in web and backend development.', '+1-555-0131')
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO public.user_roles (user_id, role) VALUES
  ...
  ('c1000031-0000-4000-8000-000000000031', 'candidate')
ON CONFLICT (user_id, role) DO NOTHING;

-- Anna Mark: populated candidate_profile (junior software engineer, moderate career)
INSERT INTO public.candidate_profiles (
  user_id, location, linkedin_url, github_url, career_objective, current_title,
  years_of_experience, industry, preferred_roles, preferred_locations,
  technical_skills, soft_skills, languages, education, work_experience, projects,
  certifications, achievements, completeness_score
) VALUES (
  'c1000031-0000-4000-8000-000000000031',
  'Austin, TX',
  'https://linkedin.com/in/annamark',
  'https://github.com/annamark',
  ...
  3,
  'Technology',
  ARRAY['Software Engineer', 'Full Stack Developer', 'Backend Developer'],
  ARRAY['Austin, TX', 'Remote', 'San Francisco, CA'],
  ARRAY['JavaScript', 'TypeScript', 'React', 'Node.js', 'Python', 'SQL', 'Git', 'REST APIs'],
  ARRAY['Communication', 'Problem solving', 'Teamwork', 'Adaptability'],
  ARRAY['English'],
  '[{"institution":"University of Texas at Austin","degree":"B.S.","field_of_study":"Computer Science","start_date":"2017-09","end_date":"2021-05","gpa":"3.4","description":"Relevant coursework: Data structures, algorithms, web development, databases."}]'::jsonb,
  '[{"company":"TechStart Solutions","title":"Junior Software Engineer","location":"Austin, TX","start_date":"2021-06","end_date":"2024-01","description":"Built and maintained internal tools and customer-facing features. Worked in an Agile team on a React/Node.js stack.","achievements":["Shipped 3 production features","Reduced API latency by 15%","Mentored one intern"]},{"company":"Local Dev Shop","title":"Software Development Intern","location":"Austin, TX","start_date":"2020-06","end_date":"2020-08","description":"Full-stack development and bug fixes for client projects.","achievements":["Delivered 2 client projects on time"]}]'::jsonb,
  '[{"title":"Task Dashboard","description":"Personal productivity app with React and Express. Auth, CRUD, and simple analytics.","technologies":["React","Node.js","PostgreSQL"],"url":"https://github.com/annamark/task-dashboard","start_date":"2023-01","end_date":"2023-03"},{"title":"API Rate Limiter","description":"Small library for in-memory rate limiting used in side projects.","technologies":["TypeScript","Node.js"],"url":"https://github.com/annamark/rate-limiter","start_date":"2022-06","end_date":"2022-08"}]'::jsonb,
  '[{"name":"AWS Certified Cloud Practitioner","issuing_organization":"Amazon Web Services","date_obtained":"2023-04","expiry_date":"","credential_id":""}]'::jsonb,
  '[{"title":"Spot bonus for delivery","description":"Recognition for on-time delivery of a critical feature.","date":"2023-09"}]'::jsonb,
  85
)
